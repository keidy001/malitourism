...
class Customizer_Library_Upsell extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div class="freelancelot-upsell">
			...
			<a href="<?php echo esc_url( 'https://www.freelancelot.co.za/wordpress-themes/oceanic/' ); ?>" target="_blank" class="freelancelot-upsell-btn"><?php echo __( 'Buy Oceanic Premium', 'oceanic' ); ?></a>
